        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {              
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Xác thực tài khoản", "Vui lòng click vào <a href=\"" + callbackUrl + "\">đây</a> để xác thực");
                    ViewBag.ThongBao = "Chúng tôi đã gửi email để xác thực tài khoản của bạn.Vui lòng vào tài khoản đăng ký để xác thực !";
